...
def build_model(input_shape=(512, 512, 3), size_boxes=4, num_objects=8):
...
def train_bbox():
    csv_file_path = '/cluster/user/chminich/Barcodes_big/prepared_annotations.csv'
    image_base_path = '/cluster/user/chminich/Barcodes_big/'
    ...
    model = build_model(input_shape=(512, 512, 3), size_boxes=4, num_objects=7)

    model.compile(optimizer='adam',
                  loss=tf.keras.losses.Huber(0.35),
                  metrics=['accuracy'])
